...
function my_theme_enqueue_styles() {
    ...
    wp_enqueue_style( 'my-theme-contact', get_stylesheet_directory_uri().'/css/contact.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-header-footer', get_stylesheet_directory_uri().'/css/header-footer.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-nav-menu', get_stylesheet_directory_uri().'/css/nav-menu.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-partenaires', get_stylesheet_directory_uri().'/css/partenaires.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-portfolio', get_stylesheet_directory_uri().'/css/portfolio.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-service', get_stylesheet_directory_uri().'/css/service.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-body', get_stylesheet_directory_uri().'/css/body.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-team', get_stylesheet_directory_uri().'/css/team.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-a-propos', get_stylesheet_directory_uri().'/css/a-propos.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-animate', get_stylesheet_directory_uri().'/css/animate/animate.min.css', ['bootstrap'] );
    wp_enqueue_style( 'my-theme-all', get_template_directory_uri().'/css/all.css', ['bootstrap'] );
}
...
function my_theme_enqueue_script() {
    ...
    wp_enqueue_script( 'my-theme-main', get_stylesheet_directory_uri().'/js/main.js', ['bootstrap','superfish'] );

    wp_enqueue_script( 'superfish', get_stylesheet_directory_uri().'/js/lib/superfish/superfish.js', ['jquery'] );

    wp_enqueue_script( 'waypoints', get_stylesheet_directory_uri().'/js/lib/easing/easing.min.js', ['jquery'] );
    wp_enqueue_script( 'waypoints', get_stylesheet_directory_uri().'/js/lib/waypoints/waypoints.min.js', ['jquery'] );
    wp_enqueue_script( 'wow', get_stylesheet_directory_uri().'/js/lib/wow/wow.min.js', ['bootstrap'] );
